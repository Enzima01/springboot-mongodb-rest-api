...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("01/01/2026"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", u2);
		Post post2 = new Post(null, sdf.parse("18/02/2026"), "Bom dia", "Acordei feliz hoje!", u1);
